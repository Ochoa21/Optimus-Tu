...
<nav class="ot-navbar">
    ...
    <div class="ot-links">
        <a href="inicio.php" class="<?php echo $pagina_actual === 'inicio' ? 'ot-activo' : ''; ?>">Inicio</a>
        <a href="test.php" class="<?php echo $pagina_actual === 'test' ? 'ot-activo' : ''; ?>">Test Vocacional</a>
        <a href="universidades.php" class="<?php echo $pagina_actual === 'universidades' ? 'ot-activo' : ''; ?>">Universidades</a>
        <a href="becas.php" class="<?php echo $pagina_actual === 'becas' ? 'ot-activo' : ''; ?>">Becas</a>
    </div>
