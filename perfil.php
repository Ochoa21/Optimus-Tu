            ...
            if (!empty($clave_nueva) || !empty($clave_actual)) {
                ...
                if (empty($clave_actual) || empty($clave_nueva)) {
                    ...
                    if (!$fila || !password_verify($clave_actual, $fila['password'])) {
                        ...
                        $tipo_mensaje = "error";
                    } elseif (!preg_match('/^(?=.*[\W]).{8,}$/', $clave_nueva)) {
                        $mensaje .= " La nueva contraseña debe tener mínimo 8 caracteres y un carácter especial.";
                        $tipo_mensaje = "error";
                    } else {
...
<div class="login-box">
    ...
    <form method="POST">
        ...
        <div class="input-box">
            <input type="password" name="clave_nueva" placeholder="Mínimo 8 caracteres y un carácter especial">
