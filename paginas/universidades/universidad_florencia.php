...
// Universidades de Florencia (archivo independiente, generado desde datos_universidades.php)
$universidades = [
    [
        'id' => 'uniamazonia',
...
<title>Universidades en Florencia | Optimus-Tu</title>
...
<div class="header">
<h1>Universidades en Florencia</h1>
