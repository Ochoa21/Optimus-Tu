...
// Universidades de Cúcuta (archivo independiente, generado desde datos_universidades.php)
$universidades = [
    [
        'id' => 'ufps',
...
<title>Universidades en Cúcuta | Optimus-Tu</title>
