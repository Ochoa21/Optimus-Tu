...
// Universidades de Neiva (archivo independiente, generado desde datos_universidades.php)
$universidades = [
    [
        'id' => 'usco',
...
<title>Universidades en Neiva | Optimus-Tu</title>
