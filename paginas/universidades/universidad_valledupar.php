...
// Universidades de Valledupar (archivo independiente, generado desde datos_universidades.php)
$universidades = [
    [
        'id' => 'unicesar',
...
<title>Universidades en Valledupar | Optimus-Tu</title>
...
<div class="header">
<h1>Universidades en Valledupar</h1>
