...
// Universidades de Pereira (archivo independiente, generado desde datos_universidades.php)
$universidades = [
    [
        'id' => 'utp',
...
<title>Universidades en Pereira | Optimus-Tu</title>
...
<div class="header">
<h1>Universidades en Pereira</h1>
