...
// Universidades de Barranquilla (archivo independiente, generado desde datos_universidades.php)
$universidades = [
    [
        'id' => 'unorte',
...
<title>Universidades en Barranquilla | Optimus-Tu</title>
...
<div class="header">
<h1>Universidades en Barranquilla</h1>
