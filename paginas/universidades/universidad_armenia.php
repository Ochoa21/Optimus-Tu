...
// Universidades de Armenia (archivo independiente, generado desde datos_universidades.php)
$universidades = [
    [
        'id' => 'uniquindio',
...
<title>Universidades en Armenia | Optimus-Tu</title>
...
<div class="header">
<h1>Universidades en Armenia</h1>
