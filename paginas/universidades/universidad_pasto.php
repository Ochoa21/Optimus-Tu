...
// Universidades de Pasto (archivo independiente, generado desde datos_universidades.php)
$universidades = [
    [
        'id' => 'udenar',
...
<title>Universidades en Pasto | Optimus-Tu</title>
