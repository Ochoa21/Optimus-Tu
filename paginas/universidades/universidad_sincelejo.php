...
// Universidades de Sincelejo (archivo independiente, generado desde datos_universidades.php)
$universidades = [
    [
        'id' => 'unisucre',
...
<title>Universidades en Sincelejo | Optimus-Tu</title>
...
<div class="header">
<h1>Universidades en Sincelejo</h1>
