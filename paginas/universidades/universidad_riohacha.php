...
// Universidades de Riohacha (archivo independiente, generado desde datos_universidades.php)
$universidades = [
    [
        'id' => 'uniguajira',
...
<title>Universidades en Riohacha | Optimus-Tu</title>
...
<div class="header">
<h1>Universidades en Riohacha</h1>
