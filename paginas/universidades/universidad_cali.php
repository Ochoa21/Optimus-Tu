...
// Universidades de Cali (archivo independiente, generado desde datos_universidades.php)
$universidades = [
    [
        'id' => 'icesi',
...
<title>Universidades en Cali | Optimus-Tu</title>
